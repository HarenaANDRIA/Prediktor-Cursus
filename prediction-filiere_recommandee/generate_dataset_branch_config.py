...
BRANCH_CONFIG = {
    'science_des_donnees_et_intelligence_artificielle': {
        ...
        'branches': {
            ...
            'specialiste_en_cybersecurite': {'label': "Spécialiste en Cybersécurité", 'required': ['linux', 'codage_et_cryptographie'], 'single_rule': ['linux', 'codage_et_cryptographie']},
